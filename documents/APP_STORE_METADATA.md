...
- You confirm you own or have rights to all content in the app
...
- Real-time sensor readings on your wrist
...
- Link to your website's support page
- Link to GitHub repository with documentation
- Link to a dedicated support page

Example: `https://www.plena.app/support` or `https://github.com/yourusername/plena-support`
...
For general information inquiries: info@plenitudo.ai
...
- iPhone 5.5" Display: 1242 x 2208 pixels (optional but recommended)

**watchOS App Screenshots:**

- Apple Watch Series 7 (45mm): 396 x 484 pixels (required)
- Apple Watch Series 4 (44mm): 368 x 448 pixels (required)

See [APP_STORE_SCREENSHOTS.md](APP_STORE_SCREENSHOTS.md) for detailed screenshot requirements and content guidelines.
...
- First 3 lines are most important (visible in preview)
- Include keywords naturally
- Use emojis sparingly (they don't help search)
- Highlight unique features (stress zones, HRV tracking)
...
5. **Screenshot 5:** Apple Watch interface (if space)

### Review Optimization

- Encourage satisfied users to leave reviews
- Respond to reviews professionally
- Update app regularly based on feedback
...
All metadata above is in English (US).
...
- [ ] App name is correct: "Plena"
- [ ] Subtitle is under 30 characters
- [ ] Short description is under 170 characters
- [ ] Full description is under 4000 characters
- [ ] Keywords are under 100 characters (no spaces after commas)
- [ ] Promotional text is under 170 characters
- [ ] Support URL is provided and working
- [ ] Privacy Policy URL is provided and working
- [ ] Support email is provided
- [ ] Screenshots are correct sizes
- [ ] App icon is uploaded (1024x1024)
- [ ] Age rating is appropriate (likely 4+)
...
- **HealthKit Apps:** Must provide privacy policy URL (required by Apple)
- **Watch Apps:** Submit separately but can link to iPhone app
- **Age Rating:** Likely 4+ (Health & Fitness apps are generally 4+)
- **Content Rights:** Ensure you have rights to all content
- **Testing:** Test all URLs before submission
- **Updates:** Can update metadata anytime without new app version
