...
- Uses multiple data sources for algorithmic estimation:
  - Accelerometer and gyroscope (motion sensors)
  - Photoplethysmography (PPG) from heart rate sensor
  - Machine learning algorithms to derive breathing rate
- **Important:** This is a derived measurement, not a direct breath count
- The measurement is algorithmically estimated rather than directly observed
...
- Series 6 introduced enhanced motion sensors and improved algorithms
- Better PPG sensor quality for more accurate derivation
- Advanced machine learning models for respiratory estimation
- Earlier models lack the necessary sensor precision and algorithms

**Important Notes:**
- Respiratory rate may take longer to appear than heart rate
- This is an **algorithmically derived estimation**, not a direct measurement
- Accuracy can be affected by:
  - Movement and device positioning
  - Signal quality from sensors
  - Individual physiological variations
  - Environmental factors
- Stay relatively still for best results
- Values may differ from direct clinical measurements
